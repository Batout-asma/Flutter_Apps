...
class ChatBoxSeller extends StatefulWidget {
  const ChatBoxSeller({super.key});

  @override
  State<ChatBoxSeller> createState() => _ChatBoxSellerState();
}

class _ChatBoxSellerState extends State<ChatBoxSeller> {
            ...
            children: [
              ...
              ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final chatPartnerEmail = conversation.sender == user?.email
